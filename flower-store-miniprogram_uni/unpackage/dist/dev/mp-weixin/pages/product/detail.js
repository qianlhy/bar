...
var _default = {
  ...
  methods: {
    loadProduct: function loadProduct(id) {
      ...
      productApi.getProductById(id).then(function (product) {
        if (product.images && typeof product.images === 'string') {
          product.images = product.images.split(',').map(function (img) {
            return img.trim();
          }).filter(Boolean);
        }
    ...
    doAdd: function doAdd(count, specText) {
      var _this3 = this;
      ...
      this.isAdding = true;
      return cartApi.addToCart(this.product.id, count, specText || '').then(function () {
        uni.showToast({
          title: '已加入购物车',
          icon: 'success'
        });
    ...
    checkoutNow: function checkoutNow(count, specText, unitPrice) {
      var item = {
...
var _detail = _interopRequireDefault(__webpack_require__(/*! ./pages/product/detail.vue */ 97));
// @ts-ignore
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _detail_vue_vue_type_template_id_0e9671aa___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./detail.vue?vue&type=template&id=0e9671aa& */ 98);
...
try {
  components = {
    specModal: function () {
      return __webpack_require__.e(/*! import() | components/spec-modal/spec-modal */ "components/spec-modal/spec-modal").then(__webpack_require__.bind(null, /*! @/components/spec-modal/spec-modal.vue */ 215))
    },
  }
} catch (e) {
  if (
...
var render = function () {
  ...
  var g0 = !_vm.isLoading && _vm.product ? _vm.product.images.length : null
  var g1 = !_vm.isLoading && _vm.product ? _vm.product.images.length : null
  var g2 =
    !_vm.isLoading && _vm.product && g1 > 1 ? _vm.product.images.length : null
  if (!_vm._isMounted) {
